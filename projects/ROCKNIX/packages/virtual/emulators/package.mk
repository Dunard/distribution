...
case "${DEVICE}" in
  ...
  SDM845|SM8250|SM8550|SM8650)
    ...
    PKG_EMUS+=" aethersx2-sa azahar-sa box64 bigpemu-sa cemu-sa dolphin-sa mednafen melonds-sa nanoboyadvance-sa picotron portmaster rpcs3-sa scummvmsa supermodel-sa \
...
makeinstall_target() {
  ...
  ### Commodore Amiga
  case ${DEVICE} in
    H700|RK3326|RK3399|RK3566|RK3588|SDM845|SM8250|SM8550|SM8650)
  ...
  ### DICE
  case ${DEVICE} in
    RK3588|S922X|SDM845|SM8250|SM8550|SM8650)
  ...
  ### Sega Model 3
  case ${DEVICE} in
    RK3588|SDM845|SM8250|SM8550|SM8650)
